                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="banks" role="tabpanel"
                                ...
                                <div class="card mb-0">
                                    ...
                                    <a href="{{route('statistics.employee_statistic').'?name=egypt_license'}}" class="btn btn-square btn-primary">طباعة الموظفين</a>
                                                ...
                                                <table class=" table display  export-without_print " id="">
                                                    ...
                                                    @foreach($branches as $branch)
                                                        <tr>
                                                            <td>{{$loop->index + 1}}</td>
                                                            <td>{{$branch->name}}</td>
                                                            <td>{{$branch->egypt_license()['yes']->count()}}</td>
                                                            <td>{{$branch->egypt_license()['no']->count()}}</td>
