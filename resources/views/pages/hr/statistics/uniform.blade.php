                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="banks" role="tabpanel"
                                ...
                                <div class="card mb-0">
                                    ...
                                    <a href="{{route('statistics.employee_statistic').'?name=uniform'}}" class="btn btn-square btn-primary">طباعة الموظفين</a>
                                            ...
                                            <div class="dt-ext table-responsive">
                                                <table class=" table display  export-without_print " id="">
                                                    ...
                                                    <tr>
                                                        <th>#</th>
                                                        <th>الفرع</th>
                                                        <th> تم استلام اليونيفورم</th>
                                                        <th>لم يتم تسليم اليونيفورم</th>
                                                        <th>المجموع</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    @foreach($branches as $branch)
                                                        <tr>
                                                            <td>{{$loop->index + 1}}</td>
                                                            <td>{{$branch->name}}</td>
                                                            <td>{{$branch->uniform()['yes']->count()}}</td>
                                                            <td>{{$branch->uniform()['no']->count()}}</td>
