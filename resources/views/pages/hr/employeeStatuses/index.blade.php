                ...
                <div class="card email-body radius-left">
                    <div class="ps-0">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="employeestatuses" role="tabpanel"
                                 aria-labelledby="employeestatuses-tab">
                                <div class="card mb-0">
                                    <div class="card-header d-flex">
                                        <h5 class="mb-0">
                                            @role('employeestatuses.store')
                                            <button class="me-2 btn-block btn-mail w-100"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#employeestatusesModal" type="button"
                                        ...
                                        <div class="modal fade modal-bookmark" id="employeestatusesModal"
                                             tabindex="-1"
                                             role="dialog" aria-labelledby="employeestatusesModalLabel"
                                             aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="banksModalLabel">حالة موظف
                                                            جديدة </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-bookmark needs-validation"
                                                              action="{{route('employeestatuses.store')}}"
                                            ...
                                            <table class=" table display  data-table-responsive" id="export-button">
                                                ...
                                                @foreach($employeeStatuss as $employeeStatus)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('employees.index',array('employeeStatus' => $employeeStatus->id))}}">{{$employeeStatus->count}}</a>
                                                        </td>
                                                        <td>
                                                            @role('employeestatuses.update')
                                                            <a class="me-2" data-bs-toggle="modal"
                                                               href="{{('/#editModal'.$employeeStatus->id)}}"><i
                                                                    data-toggle="modal"
                                                                    data-target="#editModal{{$employeeStatus->id}}"
                                                                    data-feather="edit" width="15" height='15'></i></a>
                                                            @endrole
                                                            @role('employeestatuses.destroy')
                                                            <form
                                                                action="{{ route('employeestatuses.destroy',$employeeStatus->id) }}"
                                                        ...
                                                        <div class="modal fade modal-bookmark"
                                                             id="editModal{{$employeeStatus->id}}"
                                                             tabindex="-1"
                                                             role="dialog"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form
                                                                            ...
                                                                            action="{{route('employeestatuses.update',$employeeStatus->id)}}"
                                                                            method="post"
                                                                            id="bookmark-form"
                                                                            novalidate="">
                                                                            @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(window).on('load', function () {
            ...
            $('#employeestatusesModal').modal('show');
            @endif
        });
        $(window).on('load', function () {
