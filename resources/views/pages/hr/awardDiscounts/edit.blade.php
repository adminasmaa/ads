...
@section('title', ' تعديل سلفه ومكافأة')

@section('content')
<div class="container-fluid" style="background: #f4f4f4;">
    <div class="row">
        <form class="mega-vertical" action="{{route('awardDiscounts.update',$awardDiscount->id)}}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex mb-3">
                                <input type="radio" value="discount" name="type"
                                    {{ $awardDiscount->type == 'discount' ? 'checked' : ''}} />
                                سلفه
                            </div>
                            <div class="d-flex mb-3">
                                <input type="radio" value="award" name="type"
                                    {{$awardDiscount->type=="award"?"checked":""}} />
                                مكافأة
                            </div>
                            @error('type')
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select digits choosetype" id="exampleFormControlSelect9"
                                                ...
                                                <option value='{{$employee->id}}'
                                                    {{$awardDiscount->employee_id==$employee->id?'selected':''}}>
                                ...
                                <div class="media-body">
                                    <div class="mb-3 row">
                                        <label class="col-sm-12 col-form-label"> المبلغ <span
                                                    class=" text-danger">*</span></label>
                                        <div class="col-sm-9">
                                            <input type="number" name='value' value="{{$awardDiscount->value}}"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="number" name="discount_value"
                                                    value="{{$awardDiscount->discount_value}}">
                                    ...
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            <label class="col-sm-12 col-form-label">عدد الشهور<span
                                                    class=" text-danger">*</span></label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="number" name="num_month" step="1"
                                                    disabled value="{{$awardDiscount->num_month}}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="date"  min="{{date('Y-m-d')}}" name="exchange_date"
                                                value="{{$awardDiscount->exchange_date}}">
                                            @error('exchange_date')
                                            <div style='color:red'>{{$message}}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="mb-3 mt-0 col-md-9">
                                    ...
                                    <textarea class="form-control" id="desc" name="reason"
                                        autocomplete="off">{{$awardDiscount->reason}}</textarea>
                                    @error('reason')
