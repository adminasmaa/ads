...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <form class="mega-vertical" action="{{ route('ads.update', $adsType->id) }}" method="post"
                    ...
                    <div class="card height-equal">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class=" form-control" id="start_date"
                                                    value="{{ $adsType->start_date }}" name="start_date" title="">
                                                @error('start_date')
                                                    <div style='color:red'>{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class=" form-control" id="end_date"
                                                    value="{{ $adsType->end_date }}"name="end_date" title=""
                                                    onchange="get_diff()">
                                                @error('end_date')
                                                    <div style='color:red'>{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" name="add_value" id="add_value"
                                                    value="{{ $adsType->value_today }}" onkeyup="get_total()">
                                                @error('add_value')
                                                    <div style='color:red'>{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <select class="form-select digits" id="exampleFormControlSelect9"
                                                        ...
                                                        <option value='all' <?php echo $adsType->sub_id == 'all' ? 'selected' : ''; ?>>الكل</option>
                                                        <?php foreach ($subs as $one) { ?>
                                                        <option value='<?= $one->id ?>' <?php echo $adsType->sub_id == $one->id ? 'selected' : ''; ?>>
                                                            <?= $one->name ?></option>
                                                        <?php  } ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="media-body">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="exampleFormControlTextarea4" rows="3" name="note">{{ $adsType->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @error('img1')
                                                    <div style='color:red'>{{ $message }}</div>
                                                @enderror
                                                <img src="<?= url('storage/' . $adsType->img1) ?>" border=0
                        ...
                        <div class="col-md-12">
                            <div class="card-footer text-center">
                                ...
                                <a href="{{ route('subscriptions.index') }}"> <button type="button"
