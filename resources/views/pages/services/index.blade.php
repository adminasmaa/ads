            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header"> 
                     ...
                     <a href="{{route('services.create','unit_id='.$unit_id)}}" class="btn btn-square btn-primary"> إضافة خدمة</a>
                        ...
                        <tr>
                           <td>{{$loop->index + 1}}</td>                          
                            ...
                            <td>  
                              ...
                              <a href="{{route('services.edit',[$sub->id,'unit_id='.$unit_id])}}" data-id="{{$sub->id}}"  id="edit_id" class="me-2"  width="15" height='15'>
                                <i data-feather="edit"  width="15" height='15'></i>
                              </a>
                   
                            <form action="{{ route('services.destroy', [$sub->id,'unit_id='.$sub->unit_id]) }}"
