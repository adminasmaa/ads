...
<div class="container-fluid">
          <div class="row">
          <form class="mega-vertical" action="{{route('partments.update',$partment->id)}}" method="post"
                      ...
                      <div class="col-sm-6">
                        <div class="media-body">
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" name="name" value="{{$partment->name}}" required>
                              @error('name')
                      ...
                      <div class="col-sm-6">
                        <div class="media-body">
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" name="price" value="{{$partment->price}}" required>
